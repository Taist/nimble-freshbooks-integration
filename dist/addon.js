...
},{"./lib/React":32}],"addon":[function(require,module,exports){
  ...
  start: function(_taistApi, entryPoint) {
    ...
    if (location.href.match(/freshbooks\.com\/apiEnable/i)) {
      observer.waitElement('a[name=token]', function(elem) {
        var container, parent, reactPage;
        ...
        return React.render(reactPage({}), container);
      });
    }
...
},{"./app":1,"./helpers/domObserver":2,"./react/freshbooks/apiEnable":3,"react":159}]},{},[]);
